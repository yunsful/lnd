...
func (x *HtlcSpendInfoRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HtlcSpendInfoRequest) ProtoMessage() {}

func (x *HtlcSpendInfoRequest) ProtoReflect() protoreflect.Message {
	mi := &file_signrpc_signer_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HtlcSpendInfoRequest.ProtoReflect.Descriptor instead.
func (*HtlcSpendInfoRequest) Descriptor() ([]byte, []int) {
	return file_signrpc_signer_proto_rawDescGZIP(), []int{4}
}

func (x *HtlcSpendInfoRequest) GetChanPoint() *lnrpc.ChannelPoint {
	if x != nil {
		return x.ChanPoint
	}
	return nil
...
func (x *HtlcSpendInfoRequest) GetHtlcId() uint64 {
	if x != nil {
		return x.HtlcId
	}
	return 0
...
func (x *HtlcSpendInfoRequest) GetIncoming() bool {
	if x != nil {
		return x.Incoming
	}
	return false
...
type HtlcSpendInfoResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Output value of the HTLC in satoshis.
	OutputValueSat int64 `protobuf:"varint,1,opt,name=output_value_sat,json=outputValueSat,proto3" json:"output_value_sat,omitempty"`
	// PkScript of the HTLC output.
	HtlcPkScript []byte `protobuf:"bytes,2,opt,name=htlc_pk_script,json=htlcPkScript,proto3" json:"htlc_pk_script,omitempty"`
	// Witness script for the HTLC success path (segwit v0).
	WitnessScript []byte `protobuf:"bytes,3,opt,name=witness_script,json=witnessScript,proto3" json:"witness_script,omitempty"`
	// Control block for taproot spends (empty for segwit v0).
	ControlBlock []byte `protobuf:"bytes,4,opt,name=control_block,json=controlBlock,proto3" json:"control_block,omitempty"`
	// Single tweak for the HTLC key (segwit v0).
	SingleTweak []byte `protobuf:"bytes,5,opt,name=single_tweak,json=singleTweak,proto3" json:"single_tweak,omitempty"`
	// Key descriptor used to sign.
	KeyDesc *KeyDescriptor `protobuf:"bytes,6,opt,name=key_desc,json=keyDesc,proto3" json:"key_desc,omitempty"`
	// Sighash to use.
	Sighash uint32 `protobuf:"varint,7,opt,name=sighash,proto3" json:"sighash,omitempty"`
	// Sign method to use with SignOutputRaw.
	SignMethod SignMethod `protobuf:"varint,8,opt,name=sign_method,json=signMethod,proto3,enum=signrpc.SignMethod" json:"sign_method,omitempty"`
	// True if the HTLC output is taproot.
	Taproot bool `protobuf:"varint,9,opt,name=taproot,proto3" json:"taproot,omitempty"`
	// The outpoint of the HTLC on the remote commitment transaction.
	HtlcOutpoint *lnrpc.OutPoint `protobuf:"bytes,10,opt,name=htlc_outpoint,json=htlcOutpoint,proto3" json:"htlc_outpoint,omitempty"`
}

func (x *HtlcSpendInfoResponse) Reset() {
	*x = HtlcSpendInfoResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *HtlcSpendInfoResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HtlcSpendInfoResponse) ProtoMessage() {}

func (x *HtlcSpendInfoResponse) ProtoReflect() protoreflect.Message {
	mi := &file_signrpc_signer_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HtlcSpendInfoResponse.ProtoReflect.Descriptor instead.
func (*HtlcSpendInfoResponse) Descriptor() ([]byte, []int) {
	return file_signrpc_signer_proto_rawDescGZIP(), []int{5}
}

func (x *HtlcSpendInfoResponse) GetOutputValueSat() int64 {
	if x != nil {
...
func (x *HtlcSpendInfoResponse) GetHtlcPkScript() []byte {
	if x != nil {
		return x.HtlcPkScript
	}
	return nil
}

func (x *HtlcSpendInfoResponse) GetWitnessScript() []byte {
	if x != nil {
		return x.WitnessScript
	}
	return nil
...
func (x *HtlcSpendInfoResponse) GetControlBlock() []byte {
	if x != nil {
...
func (x *HtlcSpendInfoResponse) GetSingleTweak() []byte {
	if x != nil {
		return x.SingleTweak
	}
	return nil
...
func (x *HtlcSpendInfoResponse) GetKeyDesc() *KeyDescriptor {
	if x != nil {
		return x.KeyDesc
	}
	return nil
...
func (x *HtlcSpendInfoResponse) GetSighash() uint32 {
	if x != nil {
		return x.Sighash
	}
	return 0
...
func (x *HtlcSpendInfoResponse) GetSignMethod() SignMethod {
	if x != nil {
		return x.SignMethod
	}
	return SignMethod_SIGN_METHOD_WITNESS_V0
...
func (x *HtlcSpendInfoResponse) GetTaproot() bool {
	if x != nil {
		return x.Taproot
	}
	return false
...
func (x *HtlcSpendInfoResponse) GetHtlcOutpoint() *lnrpc.OutPoint {
	if x != nil {
		return x.HtlcOutpoint
	}
	return nil
}
...
func (x *MuSig2CleanupRequest) Reset() {
	*x = MuSig2CleanupRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_signrpc_signer_proto_msgTypes[32]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MuSig2CleanupRequest) Descriptor() ([]byte, []int) {
	return file_signrpc_signer_proto_rawDescGZIP(), []int{32}
}
...
func (x *MuSig2CleanupResponse) Reset() {
	*x = MuSig2CleanupResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_signrpc_signer_proto_msgTypes[33]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MuSig2CleanupResponse) Descriptor() ([]byte, []int) {
	return file_signrpc_signer_proto_rawDescGZIP(), []int{33}
}
...
var file_signrpc_signer_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x69, 0x67, 0x6e, 0x72, 0x70, 0x63, 0x1a,
	0x0f, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x6e, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	...
	0x52, 0x08, 0x6b, 0x65, 0x79, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x61, 0x0a, 0x0d, 0x4b, 0x65,
	...
	0x2c, 0x0a, 0x07, 0x6b, 0x65, 0x79, 0x5f, 0x6c, 0x6f, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x13, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4b, 0x65, 0x79, 0x4c, 0x6f,
	0x63, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x06, 0x6b, 0x65, 0x79, 0x4c, 0x6f, 0x63, 0x22, 0x3a, 0x0a,
	...
	0x08, 0x70, 0x6b, 0x53, 0x63, 0x72, 0x69, 0x70, 0x74, 0x22, 0xe6, 0x02, 0x0a, 0x0e, 0x53, 0x69,
	0x67, 0x6e, 0x44, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x6f, 0x72, 0x12, 0x31, 0x0a, 0x08,
	0x6b, 0x65, 0x79, 0x5f, 0x64, 0x65, 0x73, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x92, 0x01, 0x0a, 0x10, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79, 0x4d, 0x65, 0x73, 0x73,
	...
	0x72, 0x53, 0x69, 0x67, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x03, 0x74, 0x61, 0x67, 0x22, 0x29, 0x0a, 0x11, 0x56, 0x65, 0x72, 0x69, 0x66, 0x79,
	...
	,
	...
	,
	...
	0x0e, 0x32, 0x16, 0x2e, 0x73, 0x69, 0x67, 0x6e, 0x72, 0x70, 0x63, 0x2e, 0x4d, 0x75, 0x53, 0x69,
	0x67, 0x32, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69,
	0x6f, 0x6e, 0x12, 0x38, 0x0a, 0x18, 0x70, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74,
	0x65, 0x64, 0x5f, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x6e, 0x6f, 0x6e, 0x63, 0x65, 0x18, 0x07,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x16, 0x70, 0x72, 0x65, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74,
	0x65, 0x64, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x95, 0x02, 0x0a,
	0x15, 0x4d, 0x75, 0x53, 0x69, 0x67, 0x32, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	...
	,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x22, 0x79, 0x0a, 0x1b, 0x4d, 0x75, 0x53, 0x69, 0x67, 0x32, 0x52, 0x65,
	...
	,
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x22, 0x54, 0x0a, 0x1e, 0x4d, 0x75, 0x53, 0x69, 0x67,
	0x32, 0x47, 0x65, 0x74, 0x43, 0x6f, 0x6d, 0x62, 0x69, 0x6e, 0x65, 0x64, 0x4e, 0x6f, 0x6e, 0x63,
	0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x32, 0x0a, 0x15, 0x63, 0x6f, 0x6d,
	0x62, 0x69, 0x6e, 0x65, 0x64, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6e, 0x6f, 0x6e,
	0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x13, 0x63, 0x6f, 0x6d, 0x62, 0x69, 0x6e,
	0x65, 0x64, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4e, 0x6f, 0x6e, 0x63, 0x65, 0x22, 0x73, 0x0a,
	0x11, 0x4d, 0x75, 0x53, 0x69, 0x67, 0x32, 0x53, 0x69, 0x67, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	,
	...
	,
...
var file_signrpc_signer_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_signrpc_signer_proto_goTypes = []interface{}{
	...
	(*HtlcSpendInfoRequest)(nil),                // 6: signrpc.HtlcSpendInfoRequest
	(*HtlcSpendInfoResponse)(nil),               // 7: signrpc.HtlcSpendInfoResponse
	(*SignReq)(nil),                             // 8: signrpc.SignReq
	(*SignResp)(nil),                            // 9: signrpc.SignResp
	(*InputScript)(nil),                         // 10: signrpc.InputScript
	(*InputScriptResp)(nil),                     // 11: signrpc.InputScriptResp
	(*SignMessageReq)(nil),                      // 12: signrpc.SignMessageReq
	(*SignMessageResp)(nil),                     // 13: signrpc.SignMessageResp
	(*VerifyMessageReq)(nil),                    // 14: signrpc.VerifyMessageReq
	(*VerifyMessageResp)(nil),                   // 15: signrpc.VerifyMessageResp
	(*SharedKeyRequest)(nil),                    // 16: signrpc.SharedKeyRequest
	(*SharedKeyResponse)(nil),                   // 17: signrpc.SharedKeyResponse
	(*TweakDesc)(nil),                           // 18: signrpc.TweakDesc
	(*TaprootTweakDesc)(nil),                    // 19: signrpc.TaprootTweakDesc
	(*MuSig2CombineKeysRequest)(nil),            // 20: signrpc.MuSig2CombineKeysRequest
	(*MuSig2CombineKeysResponse)(nil),           // 21: signrpc.MuSig2CombineKeysResponse
	(*MuSig2SessionRequest)(nil),                // 22: signrpc.MuSig2SessionRequest
	(*MuSig2SessionResponse)(nil),               // 23: signrpc.MuSig2SessionResponse
	(*MuSig2RegisterNoncesRequest)(nil),         // 24: signrpc.MuSig2RegisterNoncesRequest
	(*MuSig2RegisterNoncesResponse)(nil),        // 25: signrpc.MuSig2RegisterNoncesResponse
	(*MuSig2RegisterCombinedNonceRequest)(nil),  // 26: signrpc.MuSig2RegisterCombinedNonceRequest
	(*MuSig2RegisterCombinedNonceResponse)(nil), // 27: signrpc.MuSig2RegisterCombinedNonceResponse
	(*MuSig2GetCombinedNonceRequest)(nil),       // 28: signrpc.MuSig2GetCombinedNonceRequest
	(*MuSig2GetCombinedNonceResponse)(nil),      // 29: signrpc.MuSig2GetCombinedNonceResponse
	(*MuSig2SignRequest)(nil),                   // 30: signrpc.MuSig2SignRequest
	(*MuSig2SignResponse)(nil),                  // 31: signrpc.MuSig2SignResponse
	(*MuSig2CombineSigRequest)(nil),             // 32: signrpc.MuSig2CombineSigRequest
	(*MuSig2CombineSigResponse)(nil),            // 33: signrpc.MuSig2CombineSigResponse
	(*MuSig2CleanupRequest)(nil),                // 34: signrpc.MuSig2CleanupRequest
	(*MuSig2CleanupResponse)(nil),               // 35: signrpc.MuSig2CleanupResponse
	(*lnrpc.ChannelPoint)(nil),                  // 36: lnrpc.ChannelPoint
	(*lnrpc.OutPoint)(nil),                      // 37: lnrpc.OutPoint
}
var file_signrpc_signer_proto_depIdxs = []int32{
	...
	36, // 4: signrpc.HtlcSpendInfoRequest.chan_point:type_name -> lnrpc.ChannelPoint
	3,  // 5: signrpc.HtlcSpendInfoResponse.key_desc:type_name -> signrpc.KeyDescriptor
	0,  // 6: signrpc.HtlcSpendInfoResponse.sign_method:type_name -> signrpc.SignMethod
	37, // 7: signrpc.HtlcSpendInfoResponse.htlc_outpoint:type_name -> lnrpc.OutPoint
	5,  // 8: signrpc.SignReq.sign_descs:type_name -> signrpc.SignDescriptor
	4,  // 9: signrpc.SignReq.prev_outputs:type_name -> signrpc.TxOut
	10, // 10: signrpc.InputScriptResp.input_scripts:type_name -> signrpc.InputScript
	2,  // 11: signrpc.SignMessageReq.key_loc:type_name -> signrpc.KeyLocator
	2,  // 12: signrpc.SharedKeyRequest.key_loc:type_name -> signrpc.KeyLocator
	3,  // 13: signrpc.SharedKeyRequest.key_desc:type_name -> signrpc.KeyDescriptor
	18, // 14: signrpc.MuSig2CombineKeysRequest.tweaks:type_name -> signrpc.TweakDesc
	19, // 15: signrpc.MuSig2CombineKeysRequest.taproot_tweak:type_name -> signrpc.TaprootTweakDesc
	1,  // 16: signrpc.MuSig2CombineKeysRequest.version:type_name -> signrpc.MuSig2Version
	1,  // 17: signrpc.MuSig2CombineKeysResponse.version:type_name -> signrpc.MuSig2Version
	2,  // 18: signrpc.MuSig2SessionRequest.key_loc:type_name -> signrpc.KeyLocator
	18, // 19: signrpc.MuSig2SessionRequest.tweaks:type_name -> signrpc.TweakDesc
	19, // 20: signrpc.MuSig2SessionRequest.taproot_tweak:type_name -> signrpc.TaprootTweakDesc
	1,  // 21: signrpc.MuSig2SessionRequest.version:type_name -> signrpc.MuSig2Version
	1,  // 22: signrpc.MuSig2SessionResponse.version:type_name -> signrpc.MuSig2Version
	8,  // 23: signrpc.Signer.SignOutputRaw:input_type -> signrpc.SignReq
	6,  // 24: signrpc.Signer.GetHtlcSpendInfo:input_type -> signrpc.HtlcSpendInfoRequest
	8,  // 25: signrpc.Signer.ComputeInputScript:input_type -> signrpc.SignReq
	12, // 26: signrpc.Signer.SignMessage:input_type -> signrpc.SignMessageReq
	14, // 27: signrpc.Signer.VerifyMessage:input_type -> signrpc.VerifyMessageReq
	16, // 28: signrpc.Signer.DeriveSharedKey:input_type -> signrpc.SharedKeyRequest
	20, // 29: signrpc.Signer.MuSig2CombineKeys:input_type -> signrpc.MuSig2CombineKeysRequest
	22, // 30: signrpc.Signer.MuSig2CreateSession:input_type -> signrpc.MuSig2SessionRequest
	24, // 31: signrpc.Signer.MuSig2RegisterNonces:input_type -> signrpc.MuSig2RegisterNoncesRequest
	26, // 32: signrpc.Signer.MuSig2RegisterCombinedNonce:input_type -> signrpc.MuSig2RegisterCombinedNonceRequest
	28, // 33: signrpc.Signer.MuSig2GetCombinedNonce:input_type -> signrpc.MuSig2GetCombinedNonceRequest
	30, // 34: signrpc.Signer.MuSig2Sign:input_type -> signrpc.MuSig2SignRequest
	32, // 35: signrpc.Signer.MuSig2CombineSig:input_type -> signrpc.MuSig2CombineSigRequest
	34, // 36: signrpc.Signer.MuSig2Cleanup:input_type -> signrpc.MuSig2CleanupRequest
	9,  // 37: signrpc.Signer.SignOutputRaw:output_type -> signrpc.SignResp
	7,  // 38: signrpc.Signer.GetHtlcSpendInfo:output_type -> signrpc.HtlcSpendInfoResponse
	11, // 39: signrpc.Signer.ComputeInputScript:output_type -> signrpc.InputScriptResp
	13, // 40: signrpc.Signer.SignMessage:output_type -> signrpc.SignMessageResp
	15, // 41: signrpc.Signer.VerifyMessage:output_type -> signrpc.VerifyMessageResp
	17, // 42: signrpc.Signer.DeriveSharedKey:output_type -> signrpc.SharedKeyResponse
	21, // 43: signrpc.Signer.MuSig2CombineKeys:output_type -> signrpc.MuSig2CombineKeysResponse
	23, // 44: signrpc.Signer.MuSig2CreateSession:output_type -> signrpc.MuSig2SessionResponse
	25, // 45: signrpc.Signer.MuSig2RegisterNonces:output_type -> signrpc.MuSig2RegisterNoncesResponse
	27, // 46: signrpc.Signer.MuSig2RegisterCombinedNonce:output_type -> signrpc.MuSig2RegisterCombinedNonceResponse
	29, // 47: signrpc.Signer.MuSig2GetCombinedNonce:output_type -> signrpc.MuSig2GetCombinedNonceResponse
	31, // 48: signrpc.Signer.MuSig2Sign:output_type -> signrpc.MuSig2SignResponse
	33, // 49: signrpc.Signer.MuSig2CombineSig:output_type -> signrpc.MuSig2CombineSigResponse
	35, // 50: signrpc.Signer.MuSig2Cleanup:output_type -> signrpc.MuSig2CleanupResponse
...
func file_signrpc_signer_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_signrpc_signer_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HtlcSpendInfoRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_signrpc_signer_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HtlcSpendInfoResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_signrpc_signer_proto_msgTypes[32].Exporter = func(v interface{}, i int) interface{} {
		...
		file_signrpc_signer_proto_msgTypes[33].Exporter = func(v interface{}, i int) interface{} {
